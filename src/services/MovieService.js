...
class MovieService {
    ...
    searchMovie(keyword) {
        return axios.get(`https://api.themoviedb.org/3/search/movie?api_key=daec360a48d3f2d487024c78a901cf46&language=en-US&query=${keyword}&page=1&include_adult=false`).then(value => value.data).catch(e => console.log(e))
    }
    ...
    getCategories() {
        return  axios.get('https://api.themoviedb.org/3/genre/movie/list?api_key=daec360a48d3f2d487024c78a901cf46&language=en-US').then(value => value.data).catch(e => console.log(e))
    }
